...
Default output folder:
    results/approach1/de_results/mae_as_goal
...
DEFAULT_RESULTS_DIR = PROJECT_ROOT / _PATHS["results_approach1_de_dir"] / "mae_as_goal"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Nested-CV LIWC (German) regression optimized for MAE.")
    parser.add_argument(
        "--results-dir",
        type=Path,
        default=DEFAULT_RESULTS_DIR,
        help="Output directory. Default: results/approach1/de_results/mae_as_goal",
    )
...
def run(args: argparse.Namespace) -> None:
    ...
    print("=" * 80)
    print("APPROACH 1 (GERMAN): LIWC REGRESSION, MAE AS OPTIMIZATION GOAL")
    print("=" * 80)
