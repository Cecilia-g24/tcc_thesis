...
Default output folder:
    results/approach1/en_results/rmse_as_goal
...
DEFAULT_RESULTS_DIR = PROJECT_ROOT / _PATHS["results_approach1_en_dir"] / "rmse_as_goal"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Nested-CV LIWC (English) regression optimized for RMSE.")
    parser.add_argument(
        "--results-dir",
        type=Path,
        default=DEFAULT_RESULTS_DIR,
        help="Output directory. Default: results/approach1/en_results/rmse_as_goal",
    )
...
def run(args: argparse.Namespace) -> None:
    ...
    print("=" * 80)
    print("APPROACH 1 (ENGLISH): LIWC REGRESSION, RMSE AS OPTIMIZATION GOAL")
    print("=" * 80)
